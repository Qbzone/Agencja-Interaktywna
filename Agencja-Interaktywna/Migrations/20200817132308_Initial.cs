        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumerTelefonuSluzbowego = table.Column<string>(unicode: false, fixedLength: true, maxLength: 9, nullable: false),
                    AdresEmail = table.Column<string>(maxLength: 50, nullable: false),
                    Haslo = table.Column<string>(nullable: false),
                    CzyEmailZweryfikowane = table.Column<bool>(nullable: false),
                    KodAktywacyjny = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    menadzer = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
